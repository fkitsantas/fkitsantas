...
```yaml
name:         Fotios "Fotis" Kitsantas
role:         Software Engineer
focus:        [ C#/.NET, Java, Microservices, Event-Driven Systems ]
side_quests:  [ Reverse Engineering, Memory Injection, Game Client Analysis ]
learning:     [ Rust, Python ]
certified:    Foundational C# — Microsoft
motto:        "Break it to understand it, then build it better."
```
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/fkitsantas/fkitsantas/output/github-snake-dark.svg" />
